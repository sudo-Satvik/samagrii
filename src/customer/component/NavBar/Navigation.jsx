  ...
  return (
    <div className="bg-white">
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-primary-500 px-4 text-sm font-body text-black-800 sm:px-6 lg:px-8">
            Welcome to सामग्री (A Spiritual Story) 
        </p>
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="#">
                  <span className="sr-only">Samagrii</span>
                  <img
                    alt=""
                    src={logoImg}
